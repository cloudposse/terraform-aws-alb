resource "aws_security_group" "default" {
  count       = module.this.enabled && var.sg_default_enabled ? 1 : 0
...
resource "aws_security_group_rule" "http_ingress" {
  count             = module.this.enabled && var.sg_default_enabled && var.http_enabled ? 1 : 0
  type              = "ingress"
...
resource "aws_security_group_rule" "https_ingress" {
  count             = module.this.enabled && var.sg_default_enabled && var.https_enabled ? 1 : 0
  type              = "ingress"
