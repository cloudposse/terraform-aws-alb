...
| <a name="input_allow_ssl_requests_only"></a> [allow\_ssl\_requests\_only](#input\_allow\_ssl\_requests\_only) | Require requests to use Secure Socket Layer (HTTPS/SSL). | `bool` | `false` | no |
